...
<x-card class="p-10 rounded max-w-lg mx-auto mt-24">
    ...
    <div class="mb-6">
        ...
        <input
            ...
            name="cname" value="{{$confection->cname}}"
        />
        @error('cname')
    ...
    <div class="mb-6">
        ...
        >
            <select name="prizewinning" class="border border-gray-200 rounded p-2 w-full">
                <option value="0" <?php if ($confection->prizewinning == 0) {echo 'selected="selected"';
                } ?>>no</option>
                <option value="1" <?php if ($confection->prizewinning == 1) {echo 'selected="selected"';
                } ?>>yes</option>
            </select>
    </div>
        <div class="mb-6">
