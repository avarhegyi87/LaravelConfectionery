...
@section('content')
    ...
    <div>
        <form id="contactform" method="post" action="contact">
            ...
            <div class="w-full mb-4 bg-opacity-80 border border-gray-200 rounded-lg bg-gray-50 dark:bg-gray-700 dark:border-gray-600">
            ...
            <button type="submit" id="submitMessage"
                class="text-white bg-purple-700 disabled:bg-gray-500 hover:bg-purple-800 focus:ring-4 focus:outline-none focus:ring-purple-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-purple-600 dark:hover:bg-purple-700 dark:focus:ring-purple-800">Send
                Message</button>
        </form>
    </div>
@endsection
